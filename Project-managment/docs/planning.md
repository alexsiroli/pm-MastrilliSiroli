...
**E = (O + 4M + P) / 6**, che fornisce una stima più accurata e ponderata sulla base delle stime più ottimistiche e pessimistiche. 

Poiché siamo studenti e l’impegno settimanale reale oscilla in base a lezioni ed esami, abbiamo fissato assunzioni realistiche di capacità: **20 h/settimana/persona** e **efficienza 75%**, che equivalgono a **15 h/settimana** di lavoro effettivo. Considerando di lavorare dal lunedì al venerdì, si stima che le ore effettive siano 3 in un giorno. Nel calcolare ore->giorni, questi sono arrotondati per eccesso così da evitare ottimismi impliciti.
...
È stato costruito il **Gantt** (baseline):
