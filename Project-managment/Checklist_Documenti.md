...
- [ ] `2_Documentazione_Progetto/2.2 Planning/2208_Analisi_Rischi_e_Mitigazione.md` — Obbligatorio
- [ ] `2_Documentazione_Progetto/2.2 Planning/2207_Analisi_Cash_Flow.md` — Facoltativo (approfondisce la gestione della liquidità)
...
- [ ] `2_Documentazione_Progetto/2.2 Planning/2209_Project_Proposal_Finale.md` — Obbligatorio
...
- [ ] `1_Descrizione_Approccio/40_Monitoring_Controlling_Approccio.md` — Obbligatorio
- [ ] `2_Documentazione_Progetto/2.4 Controllo/2403_Issues_Log.md` — Obbligatorio
- [ ] `1_Descrizione_Approccio/41_Issues_Log_Gestione_Rischi.md` — Obbligatorio
- [ ] `2_Documentazione_Progetto/2.4 Controllo/2401_Project_Status_Report_Template.md` — Obbligatorio
- [ ] `2_Documentazione_Progetto/2.4 Controllo/2404_Earned_Value_Analysis_Esempio.md` — Facoltativo (strumento avanzato di controllo)
- [ ] `2_Documentazione_Progetto/2.4 Controllo/2402_Project_Impact_Statement_Template.md` — Facoltativo (da usare solo se si formalizza una richiesta di change)

## Fase 5 · Closing
- [ ] `1_Descrizione_Approccio/50_Closing_Approccio.md` — Obbligatorio
- [ ] `2_Documentazione_Progetto/2.5 Chiusura/2501_Documento_Accettazione_Cliente.md` — Obbligatorio
- [ ] `2_Documentazione_Progetto/2.5 Chiusura/2502_Audit_Post_Implementazione.md` — Obbligatorio
- [ ] `2_Documentazione_Progetto/2.5 Chiusura/2503_Rapporto_Finale_Progetto.md` — Obbligatorio
