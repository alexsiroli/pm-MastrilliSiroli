...
| RBS.2.2 | **Dettaglio evento** | La scheda evento racchiude descrizione, location, fascia oraria e prezzo.
...
| RBS.5.2 | **Interfaccia per amministratore** | Un ambiente gestionale che permette di eseguire operazioni ordinarie da parte del team, quali creaione/modifica/rimozione di un locale e moderazione delle recensioni. |
